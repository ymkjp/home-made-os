...
void HariMain(void)
{
	char winbuf[1024 * 757 * osak_getbuflen()], txtbuf[240 * 1024];
	...
	for (;;) {
		...
		if (i == 0xb4) {
			for (;;) {
				...
				if (api_getkey(0) != 0xb4) { /* もう'4'を押していなければ、処理終わり */
					break;
				}
			}
		}
